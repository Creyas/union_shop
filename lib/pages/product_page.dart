...
class _ProductPageState extends State<ProductPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedColor == null && product.colorImages.isNotEmpty) {
      selectedColor = product.colorImages.keys.first;
    }
  ...
  Widget _buildImageGallery(Product product) {
    ...
    String currentImage =
        selectedColor != null && product.colorImages.containsKey(selectedColor)
  ...
  Widget _buildProductDetails(Product product, CartProvider cartProvider) {
    ...
    List<String> availableSizes =
        product.hasSize ? ['XS', 'S', 'M', 'L', 'XL', 'XXL'] : [];
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              if (product.colorImages.isNotEmpty && selectedColor == null) {
                ScaffoldMessenger.of(context).showSnackBar(
